...
<head>
    ...
    <link rel="stylesheet" href="user_db_css/dist/css/style.css">
    ...
    /* Add additional styles as needed for buttons and other elements */
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0 is-revealing">User Dashboard</h1>
							...
							<form action="search_dates.php" method="post">
	                            <div class="control control-expanded">
	                                <input class="input" type="date" name="search" placeholder="Serch Date &hellip;">	
	                            </div>
								<div class="control">
							...
							<form action="search_event_attendance.php" method="post">
	                            <div class="control control-expanded">
	                        ...
	                        <div class="feature">
	                            <div class="feature-inner">
									<div class="feature-header mb-16">
										...
										<!-- add customer -->
		                                <h4 class="feature-title m-0"><a href="get_costomer_details.php">Add Customer</a></h4>
									</div>
							...
							<div class="feature">
	                            <div class="feature-inner">
									<div class="feature-header mb-16">
										...
										<!-- Function 2 -->
		                                <h4 class="feature-title m-0"><a href="get_event_details.php">Add Event for Existing Customer</a></h4>
									</div>
                            ...
                            <div class="feature">
	                            <div class="feature-inner">
									<div class="feature-header mb-16">
										...
										<!-- function 3 -->
		                                <h4 class="feature-title m-0"><a href="show_customers.php">Show Customers</a></h4>
									</div>
							...
							<div class="feature">
	                            <div class="feature-inner">
									<div class="feature-header mb-16">
										...
										<!-- function 4 -->
                                        <h4 class="feature-title m-0"><a href="show_bookings.php">Show Bookings</a></h4>
										<!-- <a href="show_bookings.php"><button class="feature-title m-0">Show Bookings</button></a> -->
										<!-- <a href="show_bookings.php"><input type="" class="button button-primary button-block" value="Show Bookings"></a> -->
									</div>
...
<div class="table">
	<table>
		...
		<a href="past_events.php">Veiw Past Events</a>
    ...
    <script src="user_db_css/dist/js/main.min.js"></script>
	<script>
        function checker(){
...
<body>
    <div class="container">
        <div class="col-md-6 text-center btn-container">
        <button class="btn btn-warning btn-custom"  onclick="window.location.href = 'get_costomer_details.php'">
                <img src="#" alt="">
                <span class="btn-text">Add customer</span>
            </button>
            <button class="btn btn-warning btn-custom"  onclick="window.location.href = 'get_event_details.php'">
                <img src="#" alt="">
                <span class="btn-text">Add event for excisting customer</span>
            </button>
        </div>
    </div>
</body>
