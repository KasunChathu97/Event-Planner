...
if (isset($_POST['delete_button'])) {
    ...
    if ($delete_b_id !== null) {
        ...
        $query = "DELETE FROM updated WHERE updated_time = '$delete_b_id'";
        $result = mysqli_query($conn, $query);

        if ($result) {
            echo "<script>alert('Event deleted successfully!'); window.location.href = 'update_history.php';</script>";
            exit();
        } else {
...
<div class="app-content-actions">
    ...
    <h3 class="app-content-headerText">Edit history</h3>
    <br>
        ...
        <tr scope="row">
              ...
              <?php while ($raw = mysqli_fetch_assoc($result)) { ?>
                  <tr>
                      ...
                      <td><?php echo $raw['updated_time'];?></td>
                      ...
                      <form action="#" method="POST">
                          <input type="hidden" name="delete_b_id" value="<?php echo $raw['updated_time'];?>">
...
<!-- partial -->
  ...
  <script>
      function checker(){
            var result = confirm('Are you sure do you want to delete this event history ?');
            if(result==false){
